...
from metal_supply_addressing.addresser import NAMESPACE
from metal_supply_subscriber.decoding import deserialize_data
...
def _handle_events(database, events):
    ...
    # TODO: check this if
    if block_num is None or block_id is None:
        return
    try:
